...
RSpec.describe 'Recipefoods', type: :request do
  describe 'GET recipe_foods#new' do
    before do
      @user1 = User.new(name: 'nameofuser', email:'asdt560@gmail.com', password:'6letters', encrypted_password: '$2a$12$192AtELpNZ0aZCfnSxs35umQYmbSn52FK8ML/vY.iZvDW4FvkvHn2')
      @user1.skip_confirmation!
      @user1.confirm
      @user1.save
      @food1 = Food.create(name: 'foodstuff', measurement_unit: 'gr', price: 20, quantity: 1, user_id: @user1.id)
      @recipe1 = Recipe.create(name: 'foodrecipe', preparation_time: '1.5', cooking_time: '1', description: 'lorem', public: true, user_id: @user1.id)
  ...
  describe 'PUT recipe_foods#update' do
    ...
    it 'updates a new recipefood item' do
      put "/recipes/#{@recipe1.id}/update/#{@recipe1food.id}", params: { recipe: { quantity: 535311 } }
      expect(response).to redirect_to("/recipes/#{@recipe1.id}")
      get "/recipes/#{@recipe1.id}"
